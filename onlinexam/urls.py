...
urlpatterns = [
    ...
    path('logout', LogoutView.as_view(template_name='examination/logout.html'),name='logout'),
    path('contactus', views.contactus_view),
    path('afterlogin', views.afterlogin_view,name='afterlogin'),


    path('adminclick', views.adminclick_view),
    path('adminlogin', LoginView.as_view(template_name='examination/adminlogin.html'),name='adminlogin'),
